...
const Header = () => {
  ...
  return (
    <header
      className="py-1 px-7 flex justify-between items-center
     fixed top-0 z-50 w-full border-b-[0.3px] border-[#babaff] bg-black sticky"
    >
      {/* Left Section */}
      ...
      {/* Mobile Menu */}
      <div
        className="fixed top-14 right-0 left-0 bg-black p-5 md:hidden hidden"
        id="mobileMenu"
      >
